...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\MediaObjectRepository' => ['privates', 'App\\Repository\\MediaObjectRepository', 'getMediaObjectRepositoryService', false],
    ...
    protected function getMediaObjectRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\MediaObjectRepository'] = new \App\Repository\MediaObjectRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
