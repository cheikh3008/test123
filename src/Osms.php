...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'k7A4eI0DVbPNgq5O17Fb40OPDRF3CRXI';
     ...
     * @var string
     */
    protected $clientSecret = 'JGRkRMeYOIv3GfXf';
     ...
     * @var string
     */
    protected $token = 'Basic azdBNGVJMERWYlBOZ3E1TzE3RmI0ME9QRFJGM0NSWEk6SkdSa1JNZVlPSXYzR2ZYZg==';
